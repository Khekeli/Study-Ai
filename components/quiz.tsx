            ...
            className={`h-auto py-6 px-4 justify-start text-left whitespace-normal ${
              showCorrectAnswer && answerLabels[index] === question.answer
                ...
                : showCorrectAnswer &&
                  ...
                  : selectedAnswer === answerLabels[index] && !showCorrectAnswer
    ...
    <div className="min-h-screen bg-background text-foreground">
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        <h1 className="text-3xl font-bold mb-8 text-center text-foreground">
          <span className="text-pink-500">🌸</span> {title} <span className="text-pink-500">🌸</span>
        </h1>
        <div className="relative">
          ...
          <div className="min-h-[400px] border border-pink-200 dark:border-pink-800/30 rounded-lg p-6 shadow-sm">
            {" "}
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex justify-between items-center pt-4">
                      <Button
                        ...
                        variant="ghost"
                        className="text-pink-600 hover:text-pink-700 hover:bg-pink-50 dark:text-pink-400 dark:hover:bg-pink-900/20"
                      >
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex justify-center space-x-4 pt-4">
                      <Button
                        onClick={handleReset}
                        variant="outline"
                        className="border-pink-300 hover:border-pink-400 hover:bg-pink-50 dark:border-pink-800 dark:hover:bg-pink-900/20 w-full"
                      >
                        <RefreshCw className="mr-2 h-4 w-4 text-pink-500" /> Reset Quiz
                      </Button>
                      <Button
                        onClick={clearPDF}
